...
class UseCaseModel(object):
    ...
    def __str__(self):
        return "{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|\n".format(self.TestCaseId, self.Module, self.CarId,
                                                                     ...
                                                                     self.Result)
class UseCaseModel_UC6(object):
    def __init__(self, TestCaseId, Module, CarId, RecordingId, Steeringwheel, TripParts, Interior, TestPerformedby,
                 OccupiedSeats, TestcaseDescription, ObjectId, Evaluation, DATfile,Signal,StartTimestamp,EndTimestamp,
                 FalsePositive,PassPercentage, Result):
        self.TestCaseId = TestCaseId
        self.Module = Module
        self.CarId = CarId
        self.RecordingId = RecordingId
    ...
    def __str__(self):
        return "{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}\n".format(self.TestCaseId, self.Module, self.CarId,
                                                                     ...
                                                                     self.TestPerformedby, self.OccupiedSeats,
                                                                     self.TestcaseDescription, self.ObjectId,
                                                                     self.Evaluation, self.DATfile,self.Signal,self.StartTimestamp,
                                                                     self.EndTimestamp, self.FalsePositive, self.PassPercentage,
                                                                     self.Result)
